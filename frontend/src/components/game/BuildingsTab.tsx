            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {categoryBuildings.map(({ key, building }) => {
                ...
                return (
                  <div
                    key={key}
                    className={`building-card ${building.level === 0 ? 'opacity-75' : ''}`}
                  >
                    ...
                    <div className="mb-3">
                      ...
                      {building.effect && (
                        <div className="text-xs text-slate-600">{building.effect}</div>
                      )}
                    </div>
                      ...
                      <div className="border-t border-slate-200 pt-3">
                        {upgradeCost && (
                          <div className="mb-2">
                            ...
                            <div className="text-xs text-slate-700">{formatCost(upgradeCost)}</div>
                          </div>
                        )}
